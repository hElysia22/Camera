...
public class PlayerCharacter : MonoBehaviour
{
    ...
    {
        Movement = Vector3.forward * Input.GetAxis("Vertical") + Vector3.right * Input.GetAxis("Horizontal");
        Movement = target.TransformDirection(Movement);        //采用的TransformDirection
        characterMovement.SetMovementInput(Movement);
